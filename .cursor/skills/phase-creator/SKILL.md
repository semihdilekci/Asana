...
4. Çalışma modeli: tek sohbet bitmez + `@NN-phase-XX-slug` + iterasyon etiketi.
5. Son satır: `Phase done → docs/10_IMPLEMENTATION_ROADMAP.md Faz N işareti` (roadmap maddesini Adım 4'te zaten eklediysen tekrarlama).
