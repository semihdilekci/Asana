...
const ICON_CLASS =
  'shrink-0 fill-none stroke-current stroke-[1.85] [stroke-linecap:round] [stroke-linejoin:round]';
...
const STAT_TILES = [
  {
    ...
    icon: (
      <svg className={ICON_CLASS} width="22" height="22" viewBox="0 0 24 24">
    ...
    <div className="flex flex-col gap-[var(--space-8)]">
      ...
      <div className="grid grid-cols-1 gap-[var(--space-6)] sm:grid-cols-2 lg:grid-cols-4">
        {STAT_TILES.map((tile) => (
          <Card
            key={tile.label}
            className="flex items-center gap-[var(--space-5)] p-[var(--space-6)] pr-[var(--space-7)]"
          >
            <div
        ...
        <Card className="lg:col-span-7">
          ...
          <div className="flex flex-col gap-[var(--space-5)]">
            <div className="flex items-center gap-[var(--space-4)] rounded-[var(--radius-md)] p-[var(--space-4)] transition-colors hover:bg-[var(--color-hover)]">
              ...
              >
                <svg className={ICON_CLASS} width="17" height="17" viewBox="0 0 24 24">
      ...
      {/* CTA card — primary gradient + silk texture */}
      <div
        className="relative overflow-hidden rounded-[var(--radius-xl)]"
        style={{
          background:
            'linear-gradient(199.8deg, var(--color-primary-400) 0%, var(--color-primary-700) 100%)',
      ...
      >
        <SilkBackground
          ...
          noiseIntensity={1.25}
          rotation={50}
          className="opacity-55 mix-blend-soft-light"
        />
      ...
      {/* Info row */}
      {user?.email ? (
        <Card className="flex items-center gap-[var(--space-5)] p-[var(--space-5)] pr-[var(--space-7)]">
          <div
